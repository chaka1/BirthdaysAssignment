...
public class RecyclerClickerListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerClickerListener(Context context, OnItemClickListener listener) {
